...
const rendercard=Products.map((products,index)=>{
    ...
    return <Card style={{ width: '18rem', height:'20rem',backgroundColor:'#dddbc2'}}>
                        ...
                        <div className="row mb-5">
                            <div className="col-md">
                                <div className="ftco-footer-widget mb-4">
                                    <h2 class="text-info">Fashion Me</h2>
                                    <p class="text-light bg-dark">We give the best products in the market.</p>
